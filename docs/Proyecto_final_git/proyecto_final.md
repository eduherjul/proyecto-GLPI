...
![Compatibilidad](image-32.png){ width=40% }
...
![Idioma](image-44.png){ width=50% } ![Licencia](image-45.png){ width=45% }

***Paso 3.** Pulsamos en **Instalar** ya que estamos instalándolo por primera vez.*

![Instalación](image-46.png){ width=50% }

***Paso 4.** Verificamos que cumplimos todos los requisitos y están todos correctos.*

![Verificar 1](image-48.png){ width=45% } ![Verificar 2](image-49.png){ width=45% }
...
![BBDD](image-47.png){ width=45% } ![glpi](image-50.png){ width=45% }
...
![alt text](image-51.png){ width=50% } ![Enviar](image-52.png){ width=45% }

 ![Continuar](image-53.png){ width=45% } ![Terminado](image-54.png){ width=45% }
...
\begin{tcolorbox}[colframe=blue!75!black, colback=yellow!10!white, title=CONTRASEÑAS]
\textbf{Administrador}: \textcolor{red}{``glpi-glpi''}\\
\textbf{Técnico}: \textcolor{red}{``tech-tech''}\\
\textbf{Cuenta sólo lectura}: \textcolor{red}{``post-only-postonly''}\\
\textbf{Cuenta normal}: \textcolor{red}{``normal-normal''}
\end{tcolorbox}

*Inicialmente **Acceso y Contraseña** serán **glpi***

![Logout](image-55.png){ width=20% } ![Panel](image-56.png){ width=75% }
...
![usuarios](image-57.png){ width=50% }

![alta](image-58.png){ width=50% }
...
![perfiles](image-59.png){ width=50% }
...
![permisos](image-60.png){ width=50% }

![diagrama](image-61.png){ width=30% }
...
![ext.QR](image-62.png){ width=50% } ![alt text](image-65.png){ width=30% }
...
![QR](image-66.png){ width=12% } ![alt text](image-68.png){ width=50% }
...
![Peticiones](image-69.png){ width=50% }
...
![Documentos](image-63.png){ width=65% }

***Añadimos un documento nuevo, en nuestro caso una imagen.***

![Añadir-documento](image-64.png){ width=100% }
